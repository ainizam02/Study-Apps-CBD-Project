...
public class StartProgram {
    static List<AssignmentTracking> plannerItems = new ArrayList<>();
    static int nextId = 1;
    ...
    public static void main(String[] args) {
        ...
        addButton.addActionListener(e -> {
            ...
            if (!course.isEmpty() && !assignment.isEmpty() && !dueDate.isEmpty()) {
                AssignmentTracking newItem = new AssignmentTracking(nextId++, course, assignment, dueDate);
        ...
        editButton.addActionListener(e -> {
            int selectedIndex = table.getSelectedRow();
            if (selectedIndex != -1) {
                AssignmentTracking selectedItem = plannerItems.get(selectedIndex);
        ...
        scheduleButton.addActionListener(e -> {
            if (plannerItems.isEmpty()) {
               ...
               TaskPrioritization.showSchedule(frame, plannerItems);
    }});
